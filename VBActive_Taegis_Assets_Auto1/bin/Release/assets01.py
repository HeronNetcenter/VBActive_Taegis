...
token = oauth_client.fetch_token(token_url='https://api.delta.taegis.secureworks.com/auth/api/v2/auth/token', client_id=CLIENT_ID, client_secret=CLIENT_SECRET)

# Show me the first 10.000 assets (All) - options are All | Active | Deleted
# Campos incluidos em 27/03/26:
      # osRelease
      # systemType
      # status
      # osDistributor
# 28/07/23: Query allAssets substituida por assetsV2 para incluir todos os endpoints do cliente
